...
def detect_traffic_lights(PATH_TO_TEST_IMAGES_DIR, MODEL_NAME, Num_images, plot_flag=False):
    ...
    with detection_graph.as_default():
        ...
        with tf.compat.v2.io.gfile.GFile(PATH_TO_CKPT, 'rb') as fid:    # -> instead of tf.gfile.GFile()
    ...
    with detection_graph.as_default():
        with tf.compat.v1.Session(graph=detection_graph) as sess:    # -> instead of  tf.Session(
